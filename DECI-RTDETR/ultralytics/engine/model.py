...
class Model(nn.Module):
    ...
    def _check_is_pytorch_model(self):
        ...
        if not (pt_module or pt_str):
            raise TypeError(
                ...
                f"PyTorch models can val, train, predict and export, i.e. 'model.val(data=...)', but exported "
                f"formats like ONNX, TensorRT etc. only support 'predict' and 'train' modes, "
    ...
    def train(self, trainer=None, **kwargs):
        ...
        args = {**overrides, **custom, **kwargs, 'mode': 'val'}  # highest priority args on the right
        # if args.get('resume'):
